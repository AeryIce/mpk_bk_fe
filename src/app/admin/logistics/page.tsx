...
<div className="flex items-center justify-between">
  <div>
    <h2 className="text-lg font-semibold">Logistik & Resi</h2>
    <p className="text-sm text-slate-500">Input resi, pantau kurir & status perjalanan.</p>
  </div>
  <div className="flex gap-2">
    <button className="btn btn-ghost">Filter: Dalam Perjalanan</button>
    <button className="btn btn-primary">+ Input Resi</button>
  </div>
</div>

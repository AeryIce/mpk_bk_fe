...
export default function LabelPreviewPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-slate-100 p-4 print:bg-white">
      <div className="mx-auto bg-white rounded-xl shadow p-4 print:shadow-none print:p-0"
        ...
        <div className="flex items-center justify-between border-b pb-2">
          ...
          {/* logo optional—gunakan <img> kecil biar no-config */}
        ...
        <div className="grid grid-cols-2 gap-3 mt-3 h-[calc(148mm-60px)]">
          ...
          <div className="col-span-1 flex flex-col">
            ...
            <div className="mt-2 text-xs text-slate-600">
              PIC: <span className="font-medium">{pic}</span>{jabatan ? ` (${jabatan})` : ""}
            </div>
          ...
          <div className="col-span-1 flex flex-col items-center justify-center">
            ...
            <div className="mt-2 text-[10px] text-slate-500 text-center break-words">
              Scan untuk navigasi
            </div>
          </div>
        </div>
